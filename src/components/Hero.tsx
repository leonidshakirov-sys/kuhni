  ...
  return (
    <section
      className={cn(
        ...
        compact ? "min-h-[22rem] md:min-h-[70vh]" : "min-h-[28rem] md:min-h-[86vh]",
      )}
    >
      ...
      <div className="container-site relative flex min-h-[inherit] items-end pb-28 pt-10 md:pb-24 md:pt-32">
        <div className="max-w-2xl text-white">
          ...
          <TitleTag className="font-display text-[1.85rem] leading-[1.12] sm:text-[2.35rem] md:text-6xl">
            {title}
          </TitleTag>
