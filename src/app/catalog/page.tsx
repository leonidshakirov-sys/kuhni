      ...
      <Section>
        <Container>
          <SectionHeading
            ...
            text="Карточки показывают тип изделия, характеристики и стартовую стоимость базового варианта. Точную цену считаем по вашим размерам, материалам и наполнению."
          />
