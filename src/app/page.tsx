        ...
        <Container>
          <div className="flex flex-wrap items-end justify-between gap-4">
            <SectionHeading
              ...
              text="Примеры популярных решений со стартовой стоимостью. Итоговую цену рассчитаем по вашим размерам."
            />
        ...
        <Container>
          <div className="max-w-3xl">
            ...
            <p className="mt-4 leading-relaxed text-muted">
              ...
              размеры или фото помещения. Свяжитесь с нами в WhatsApp или Telegram. Юридическое
              лицо — ИП Шакиров Леонид Альбертович. Не публикуем сроки, гарантии и «самые низкие
              цены», которых нет в исходных данных.
            </p>
            <p className="mt-4 leading-relaxed text-muted">
              Отдельные страницы —{" "}
